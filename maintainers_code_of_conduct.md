...
- **MUST**, for kernels, follow our [Kernel Guidelines](https://github.com/Project-Legionos/docs/blob/master/kernel_guidelines.md).
...
- About Magisk, the maintainers **MUST NOT**:
  ...
  - Do any modifications that may lead to Magisk not work, as per the [Kernel Guidelines](https://github.com/Project-Legionos/docs/blob/master/kernel_guidelines.md).
